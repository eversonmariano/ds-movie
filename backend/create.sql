create table tb_movie (id bigint not null auto_increment, count integer, image varchar(255), score double precision, title varchar(255), primary key (id)) engine=InnoDB;
create table tb_score (value double precision, movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id)) engine=InnoDB;
create table tb_user (id bigint not null auto_increment, email varchar(255), primary key (id)) engine=InnoDB;
alter table tb_score add constraint FK23yhb6qop0f6hnb72hcorm3cv foreign key (movie_id) references tb_movie (id);
